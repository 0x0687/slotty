#[test_only]
module slotty::game_utils_tests;

use slotty::game_utils::{u64_to_string, bytes_to_u64, compute_stopping_value};
use std::string;

#[test]
fun u64_to_string_correct() {
    assert!(u64_to_string(0) == string::utf8(b"0"));
    assert!(u64_to_string(1) == string::utf8(b"1"));
    assert!(u64_to_string(5) == string::utf8(b"5"));
    assert!(u64_to_string(10) == string::utf8(b"10"));
    assert!(u64_to_string(11) == string::utf8(b"11"));
    assert!(u64_to_string(1111) == string::utf8(b"1111"));
    assert!(u64_to_string(854) == string::utf8(b"854"));
    assert!(u64_to_string(1055) == string::utf8(b"1055"));
    assert!(u64_to_string(055) == string::utf8(b"55")); // Leading 0 gets removed
}
